...
class mesh  
{
	...
	void	LoadMtl(std::string tex_file, int test_scene);
...
public:
	...
	void	LoadMesh(std::string scene_file, int test_scene);
	
	mesh();
	mesh(const char* obj_file, int test_scene);
	virtual ~mesh();

	void Init(const char* obj_file, int test_scene);
